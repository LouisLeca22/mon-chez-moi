...
function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopied && <p className='linkCopied'>Le lien a été copié</p>}
      ...
      <div className='listingDetails'>
        ...
        {listing.offer && (
          <p className='discountPrice'>
            escompte de {listing.regularPrice - listing.discountedPrice} €
          </p>
        )}
        <ul className='listingDetailsList'>
          ...
          <li>{listing.parking && 'Emplacement de parking'}</li>
